...
def draw_graph_gt(mtx, _head, vers='v1', thres=0.3):
    if type(mtx) == list:
        n = len(_head)
        g = gt.Graph()
        g.add_vertex(n)
...
#                     vpS[g.vertex(i)] = "pentagon"
            ...
            ft = '.svg'
            im_name = os.path.join('.', 'imgFolder-0526-12', str(t).zfill(3) + ft)
...
#             break
#         return
#         img2video('./imgFolder-0526-12', './imgFolder-0526-12/fault_prop.avi', fps=6, zn=3, ft=ft)
...
draw_graph_gt(mtx, _head, 'v2', thres=0.3)
